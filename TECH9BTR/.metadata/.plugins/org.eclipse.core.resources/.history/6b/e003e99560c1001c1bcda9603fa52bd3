<%@ page language="java" import="java.sql.ResultSet" import="java.sql.Statement" import="java.sql.Connection" import="java.sql.DriverManager" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
				...
				<div class="card-body" style="background: linen;">
					<div class="row">
						<div class="col-md-4 col-sm-4 col-xl-4 bg-light text-center">
							<span> Depart date:<%=rs.getString("Depart_date")%>
							</span>
						</div>
						...
						<div class="col-md-4 col-sm-4 col-xl-4 bg-light text-center">
							<span> Destination Country: <%=rs.getString("dest_country")%>
							</span>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-3 col-xl-3 bg-light text-center">
							<span> Departure country: <%=rs.getString("depart_country")%>
							</span>
						</div>


						<div class="col-md-3 col-sm-3 col-xl-3  text-center">
							<span> Accommodation Required: <%=rs.getString("accomodation")%>
							</span>
						</div>

						<div class="col-md-3 col-sm-3 col-xl-3 bg-light text-center">
							<span> Advance Amount: <%=rs.getString("adv_amt")%> <%=rs.getString("currency")%>
							</span>
						</div>

						<div class="col-md-3 col-sm-3 col-xl-3 text-center">
							<span> Estimated Cost: <%=rs.getString("est_cost")%> <%=rs.getString("currency")%> 
							</span>
						</div>
					</div>
