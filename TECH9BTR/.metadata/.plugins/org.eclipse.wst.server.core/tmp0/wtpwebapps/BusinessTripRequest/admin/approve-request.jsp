...
<body>
	...
	<%      
			...
			try
			{
				...
				if(sid.equals("2")){
					 query = "update batch9btr_approval_l1 set approval_status = 'approved' where trip_id = '"+tid+"'";
				}
				else if( sid.equals("3")){
					 query = "update batch9btr_approval_l2 set approval_status = 'approved' where trip_id = '"+tid+"'";
				}
				else if ( sid.equals("4")){
					 query = "update batch9btr_approval_l3 set approval_status = 'approved' where trip_id = '"+tid+"'";
				}
				else{
					 query = "";
				}
